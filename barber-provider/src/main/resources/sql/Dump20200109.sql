...
--
-- Table structure for table `t_biz_bought`
--

DROP TABLE IF EXISTS `t_biz_bought`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `t_biz_bought` (
  `id` varchar(50) COLLATE utf8_bin NOT NULL,
  `user_id` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `bought_id` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `status` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `flag` bit(1) DEFAULT NULL,
  `create_by` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `modify_by` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
--
-- Dumping data for table `t_biz_bought`
--

LOCK TABLES `t_biz_bought` WRITE;
/*!40000 ALTER TABLE `t_biz_bought` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_biz_bought` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_biz_charge`
--

DROP TABLE IF EXISTS `t_biz_charge`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `t_biz_charge` (
  `id` varchar(50) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `t_biz_charge`
--

LOCK TABLES `t_biz_charge` WRITE;
/*!40000 ALTER TABLE `t_biz_charge` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_biz_charge` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `t_biz_pay`
--

DROP TABLE IF EXISTS `t_biz_pay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `t_biz_pay`
--

LOCK TABLES `t_biz_pay` WRITE;
/*!40000 ALTER TABLE `t_biz_pay` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_biz_pay` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `t_biz_position`
--

DROP TABLE IF EXISTS `t_biz_position`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `t_biz_position` (
  `id` varchar(50) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `t_biz_position`
--

LOCK TABLES `t_biz_position` WRITE;
/*!40000 ALTER TABLE `t_biz_position` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_biz_position` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `t_biz_user`
--
...
CREATE TABLE `t_biz_user` (
  ...
  `wx_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `mobile` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `nick_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `password` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `gender` bit(1) DEFAULT NULL,
  `experience` varchar(1000) COLLATE utf8_bin DEFAULT NULL,
  `positions` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `salary` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `onjob` bit(1) DEFAULT NULL,
...
--
-- Dumping data for table `t_biz_user`
--

LOCK TABLES `t_biz_user` WRITE;
/*!40000 ALTER TABLE `t_biz_user` DISABLE KEYS */;
INSERT INTO `t_biz_user` VALUES ('6e4a29dde0df4f86bd93ca35df494038',NULL,NULL,NULL,'dfff',NULL,'vvv',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,_binary '',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `t_biz_user` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `t_sys_dict` VALUES (12,'12','3123',-1,'123213',NULL,NULL,NULL,'2019-11-27 07:18:06',NULL,'all',NULL),(13,'124','142',12,'1142',NULL,NULL,NULL,'2019-11-27 07:18:12',NULL,'all',NULL),(14,'124','12424',12,'1525',NULL,NULL,NULL,'2019-11-27 07:18:16',NULL,'all',NULL),(15,'21','215521',12,'5125',NULL,NULL,NULL,'2019-11-27 07:18:19',NULL,'all',NULL),(16,'125','152',12,'515125',NULL,NULL,NULL,'2019-11-27 07:18:21',NULL,'all',NULL),(17,'21512','525',12,'51251',NULL,NULL,NULL,'2019-11-27 07:18:25',NULL,'all',NULL);
...
-- Dump completed on 2020-01-09 11:34:12
