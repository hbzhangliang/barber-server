...
public class RedisUtils {
    ...
    public void setStringSet(String key,List<String> values){
        redisTemplate.opsForSet().add(key,values.toArray());
    }

    public Set<String> getStringSet(String key){
        return redisTemplate.opsForSet().members(key).stream().map(p->{return p.toString();}).collect(Collectors.toSet());
    }
    public void addStringSet(String key,String value){
        redisTemplate.opsForSet().add(key,value);
    }
    public void delStringSet(String key,String value){
